(() => {
    ...
    function ensureSkillTreeAssets() {
        if (!document.querySelector("link[data-managed-skill-tree-style]")) {
            ...
            style.href = new URL("../../assets/css/pages/character-skill-tree.css?v=20260716-skill-changes1", window.location.href).toString();
        ...
        skillTreeModulePromise = new Promise((resolve, reject) => {
            ...
            script.src = new URL("../../assets/js/shared/character-skill-tree.js?v=20260716-skill-changes1", window.location.href).toString();
            script.defer = true;
